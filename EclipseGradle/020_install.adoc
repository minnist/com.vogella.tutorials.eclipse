...
image::img/marketplace_buildship.png[Eclipse Gradle installation via the Marketplace]
...
image::img/updatesite_dialoggradle.png[Eclipse Gradle installation via the update manager]
