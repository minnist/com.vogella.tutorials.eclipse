...
In the _Run Configuration..._ you can choose between different launch
configuration types:
...
When pressing _Next_ you can choose, which launch configuration you
want to export and define a location to store the _*.launch_
file.
