...
Select the _Hello, World Command_ template and press the btn:[Next] button. This template uses the 3.x API, which you convert to the e4 API in <<firstplugin_migratione4>>.
