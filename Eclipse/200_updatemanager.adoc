...
image::UpdateManager08.png[Selecting an update site in the update manager,pdfwidth=60%]
...
image::UpdateManager10.png[Selecting an update site in the update manager,pdfwidth=60%]
