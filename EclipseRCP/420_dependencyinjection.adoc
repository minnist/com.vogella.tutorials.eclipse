...
The most important annotations are covered in <xref linkend="dependencyinjection_eclipseannotations" /> , other more special annotations are covered in there corresponding chapters.
...
For a summary of all standard annotations defined in the Eclipse platform see <xref linkend="eclipse4_annotations" />
====
...
This will be explained later in <xref linkend="context_creationprocess" />.

NOTE:This does not mean that Eclipse tracks the fields of the value to which the key points.
