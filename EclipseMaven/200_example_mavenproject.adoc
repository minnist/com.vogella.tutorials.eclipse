...
image::img/m2e_newmavenproject20.png[Create Maven project in Eclipse - Part 2]
...
image::img/m2e_newmavenproject30.png[Create Maven project in Eclipse - Part 3]

On the last tab enter the GAV of your project similar to the following screenshot.

image::img/m2e_newmavenproject40.png[Create Maven project in Eclipse - Part 4]
	
	
[[example_eclipsemavenproject_runningthebuild]]
=== Run the build
...
image::img/m2e_newmavenproject50.png[Run Maven project in Eclipse]	
...
image::img/m2e_newmavenproject60.png[Run Maven project in Eclipse]	
				
		
[[example_eclipsemavenproject_dependency]]
...
image::img/me2_adddependency20.png[]
...
image::img/me2_adddependency30.png[]	


[[example_eclipsemavenproject_usage]]
=== Use library
