...
image::jdtbrackets10.png[Highlight the enclosing brackets in JDT,width=30%]
...
image::jdtbrackets20.png[Without highlight the enclosing brackets in JDT, pdfwidth=40%]

image::jdtbrackets30.png[With highlight the enclosing brackets in JDT, pdfwidth=40%]

=== Code cleanup during save via save actions

Eclipse can cleanup your code and format it automatically during save (shortcut: kbd:[Ctrl+S]).
...
image::jdt_completion04.png[JDT completion,width=30%]
