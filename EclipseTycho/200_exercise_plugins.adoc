...
The following description demonstrates how to build Eclipse plug-ins with Maven Tycho.
...
Create the following pom in the _bundles_directory.
...
Afterwards, switch to your plug-in directory and run the build from this directory. 
