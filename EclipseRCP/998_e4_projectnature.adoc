...
NOTE:The _Package Explorer_ view may have a filter set for _.*resources_. You can modify this filter via the view menu as depicted in the following screenshot.
