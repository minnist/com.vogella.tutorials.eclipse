...
You can customize the available search tabs via the _Customize_ button in the Search dialog. 
...
In a lot of cases you can also use the mouse to navigate to or into an element if you press the kbd:[Ctrl]
...
image::breadcrumb10.png[Show in Breadcrumb]
