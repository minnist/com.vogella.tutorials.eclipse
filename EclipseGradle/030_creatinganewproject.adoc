...
image::img/gradle_new_wizard.png[New Gradle project wizard]
...
image::img/create_project_config_page.png[New Gradle project configuration page]
...
image::img/create_project_preview_page.png[New Gradle project preview page]

image::img/create_project_result.png[New Gradle project wizard result]	
