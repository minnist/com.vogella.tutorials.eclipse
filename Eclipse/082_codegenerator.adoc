...
image::generate10.png[Code generation,pdfwidth=60%]
...
Select
menu:Source[Generate Constructor using Fields...], mark both fields and click the _OK_ button.
	
image::sourcegenerator10.png[Generating,pdfwidth=60%]
	
Select
menu:Source[Generate Getter and Setter...], select all fields and afterwards click the _OK_ button.
