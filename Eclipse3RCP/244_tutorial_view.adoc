...
image::addview80.gif[Data for the "org.eclipse.ui.views" extension point,pdfwidth=60%]
		
image::addview90.png[Data for the "org.eclipse.ui.views" extension point,pdfwidth=60%]
...
image::addview110.gif[Adding a view to your perspective via the "org.eclipse.ui.perspectiveExtensions" extension,pdfwidth=60%]
...
image::addview130.png[Maintaining the layout data for the view in the `org.eclipse.ui.perspectiveExtensions` extension point,pdfwidth=60%]

=== Result
		
Run your application to see the result.
		
image::addview200.gif[Running application with a new view,pdfwidth=60%]
