...
When pressing on the _class*:_ hyperlink of the wizard entry, the following dialog will appear.
...
Start an Eclipse IDE and open the _New_ dialog by using menu:File[New > Other...] menu or simply press kbd:[CTRL + N] and choose the MyNewWizard wizard.
