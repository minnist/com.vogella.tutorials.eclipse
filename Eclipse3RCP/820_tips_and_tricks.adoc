...
http://www.vogella.com/tutorials/EclipseCommands/article.html#standardcommands - Eclipse Commands
.
...
image::unuseddependency10.gif[How to remove unused dependencies,pdfwidth=60%]
