...
In this exercise you create a servlet
...
called
_com.vogella.web.filecounter_
by selecting
menu:File[New > Other... > Web > Dynamic Web Project].
...
_Generate web.xml deployment descriptor_
on the last page.
