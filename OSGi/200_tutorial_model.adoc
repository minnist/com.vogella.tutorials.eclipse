...
In this exercise you create a plug-in for the
definition of
your
data model. You also
make this
...
NOTE: You see an error for your final id field. This error is solved in the <<services_todo_constructor>> section.
...
NOTE: The _id_ is final and therefore Eclipse creates only a getter. This is correct and desired.
...
NOTE: Why is the _id_ field marked as final? 
