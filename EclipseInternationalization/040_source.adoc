...
WARNING: This part of the description is included for completeness. It describes the NLS approach for translation. This
approach
still
works
...
image::i22n_source10.png[Externalizing strings in source files dialog,width=60]
