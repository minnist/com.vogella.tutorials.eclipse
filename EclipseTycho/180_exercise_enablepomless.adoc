...
[TIP]
====
The _Project Explorer__ view allows to see hierarchical projects. See screenshot for the required setting.

image::img/projectexplorer_hierarchicalview.png[Project Explorer - hierarchical view]
====
...
image::img/new_general_project_tycho2.png[Create new project of type general - Part 2]
...
image::img/new_general_project_configuration_tycho.png[Create new project for the Tycho configuration]
...
image::img/tychodirectory_buildsetup.png[Directory after first build setup]
