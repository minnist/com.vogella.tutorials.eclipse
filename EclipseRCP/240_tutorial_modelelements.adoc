...
image::tutorial_model50.png" scale="50[Screenshot of the application,pdfwidth=60%]
...
image::tutorial_model04.png" scale="35[Adding a Perspective,pdfwidth=60%]
...
image::tutorial_model20.png" scale="30[Change the orientation attribute,pdfwidth=60%]
...
image::tutorial_model30.png" scale="60[Application model structure,pdfwidth=60%]
...
image::tutorial_model40.png" scale="30[Part data,pdfwidth=60%]
