...
image::targetdefinitionproject10.png[Create a project for your target definition file,pdfwidth=60%]
...
image::tutorial_targetdefinition10.png[Define target definition file,pdfwidth=60%]

Press the
btn:[Add...]
button.

image::tutorial_targetdefinition20.png[Add content to target definition file,pdfwidth=60%]

Select
_Software site_
in the following dialog.

image::tutorial_targetdefinition30.png[Add content to target definition file,pdfwidth=60%]
...
image::tutorial_targetdefinition40.png[,pdfwidth=60%]
...
image::tutorial_targetdefinition60.png[,pdfwidth=60%]
