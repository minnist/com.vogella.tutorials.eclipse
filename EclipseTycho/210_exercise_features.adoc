...
[[tychofeaturesexercise_featuredirectorycreate]]		
...
image::img/tycho-feature-creation.png[Feature creation for Tycho]

Add the _com.vogella.tycho.plugin1_ plug-in to the feature.

image::img/tycho-feature-creation2.png[Add plug-in to feature]
