...
image:img/rebase.png[Rebase, 600,600]
...
image:img/merge-tool-2.png[Merge Tool,400,400]				
				
Edit the left side until you are happy with the change and save
				
image:img/merge-tool-resolved-conflict-2.png[Merge Tool with resolved conflict,400,400]						
...
image:img/rebase-continue.png[Rebase Continue,400,400]					
...
image:img/show-additional-refs.png[Show Additional Refs,400,400]
====
...
image:img/rebase_interactive_squaschcommits10.png[Squash a commit,400,400]
