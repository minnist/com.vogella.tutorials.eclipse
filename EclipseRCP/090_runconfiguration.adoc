...
image::lauchconfiguration20.png[Shows the run configuration, highlighting the location setting,pdfwidth=60%]
...
image::launchconfiguration40.png[-consoleLog in the run configuration,pdfwidth=60%]
