...
Oomph provides the possibility to implement a profile, which contains all the tasks for setting up Eclipse.
So that one only has to run the Oomph installer and choose this profile and every setting from that profile will be applied automatically.
