...
image::img/import_wizard.png[Gradle import wizard]
	

After pressing the btn:[Next >] button, you need to specify the root directory of your Gradle project.
	
image::img/import_gradle_project.png[Import Gradle project]
...
image::img/import_options_gradle.png[Import Gradle project]
	
	
Afterwards the import preview is shown.
	
image::img/import_gradle_preview.png[Import Gradle project review]
