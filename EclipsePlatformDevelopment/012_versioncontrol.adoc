...
image::eclipsegitrepos10.png" scale="30[Eclipse Platform UI search result]
...
image::eclipsedash10.png" scale="30[Project members dash]
...
image::eclipsedash20.png" scale="30[Eclipse project dashboard]
