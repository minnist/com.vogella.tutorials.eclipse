...
image::./images/clone_e4_perspective_switcher.png[Clone the ﻿e4-perspective-switcher]
...
image::./images/perspective_switch_addon.png[Perspective switch addon]
...
image::./images/perspective_switch_addon_result_app.png[Perspective switch addon result]
